    ...
    return (
        ...
        <div  className="contentIconAndImput_craeteRecipe">
            <div>
                ...
                <input className="inputTimeAndPortion_craeteRecipe" type="text" placeholder='time of cooking'/>
            </div>
                    
            <div>
                <img className="icon_craeteRecipe" src={portions} alt="x" />
                <input className="inputTimeAndPortion_craeteRecipe"  type="text" placeholder='portions'/>
             </div>
        </div>
